			...
			<div class="range-widget-container fade-in">
					...
					<div class="range-slider-wrapper">
						<div id="avg-price">
							<div class="range-title">
								...
								<span class="range-title-desc">Choose the average price of an online order that is placed at your restaurant.</span>
							</div>
							<span
								id="rs-bullet--price"
								class="rs-label"
						...
						<div class="box-minmax bottom-rounded-corners">
							<div class="range-slider-input">
								<input
									...
									max="200"
									style={{
									background: "linear-gradient(90deg, rgb(12, 78, 126) 49%, rgb(215, 220, 223) 49.1%)"
								}}></input>
							</div>
					...
					<div class="range-slider-wrapper">
						<div id="avg-amt">
							<div class="range-title">
								...
								<span class="range-title-desc">Choose the average number of online orders that you receive in one week.</span>
							</div>
							<span
								id="rs-bullet--amt"
						...
						<div class="box-minmax bottom-rounded-corners">
							<div class="range-slider-input">
								<input
									...
									max="500"
									style={{
									background: "linear-gradient(90deg, rgb(12, 78, 126) 94%, rgb(215, 220, 223) 94.1%)"
								}}></input>
							</div>
							<div class="box-minmax-key">
								<span>0</span>
				...
				<div class="competitor-wrapper">
					<div class="range-title">
						...
						<span class="range-title-desc">Compare companies and see how much money you could be save by using Ordereze.</span>
					</div>
					<div class="list-of-competitors bottom-rounded-corners">
						<div id="grubhub" class="competitor-container">
							<div class="competitor-company-commission-wrapper">
								...
								<span class="competitor-commission-amt">at
									<span class="odometer">~20%</span>
									per order is costing you annually</span>
							</div>
							<span id="grubhub-competitor" class="competitor-price-amt competitor-red">$479,024</span>
						</div>
						<div id="eatstreet" class="competitor-container">
							...
							<span id="eatstreet-competitor" class="competitor-price-amt competitor-red">$287,414</span>
						</div>
						<div id="chownow" class="competitor-container">
							<div class="competitor-company-commission-wrapper">
								...
								<span class="competitor-commission-amt">at
									<span>$119</span>
									per month (with annual contract) is costing you annually</span>
							</div>
							<span id="chownow-competitor" class="competitor-price-amt competitor-red">$1,428</span>
						</div>
						<div id="menufy" class="competitor-container">
							...
							<span id="menufy-competitor" class="competitor-price-amt competitor-red">$36,660</span>
						</div>
						...
						<div id="uber-eats" class="competitor-container">
							...
							<span id="uber-eats-competitor" class="competitor-price-amt competitor-red">$718,536</span>
						</div>
						...
						<div id="door-dash" class="competitor-container">
							...
							<span id="door-dash-competitor" class="competitor-price-amt competitor-red">$479,024</span>
						</div>
						<div id="ordereze" class="competitor-container">
							<div class="competitor-company-commission-wrapper">
								...
								<span class="competitor-commission-amt">at
									...
									is costing you annually</span>
							</div>
							<span id="ordereze-competitor" class="competitor-price-amt competitor-green">$2,388</span>
						</div>
					</div>
				</div>
			</div>
