	...
	>
		<defs>
			<linearGradient id="linear" x1="40%" y1="0%" x2="60%" y2="0%" spreadMethod="pad">
				<stop offset="100%" stop-color="#ff5910" />
			</linearGradient>
		</defs>
		<title>logo</title>
		<path
...
export const Marker = (props) => (
	<svg id="marker" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 88.06 12">
		...
		<g id="Upper_Board" data-name="Upper Board">
			<g id="Marker">
				<rect class="cls-1" x="4.15" width="62.3" height="12" />
				<path class="cls-2" d="M2,0H4.15a0,0,0,0,1,0,0V12a0,0,0,0,1,0,0H2a2,2,0,0,1-2-2V2A2,2,0,0,1,2,0Z" />
				<rect class="cls-2" x="8.31" y="3" width="16.61" height="6" />
				<rect class="cls-2" x="66.46" width="12.46" height="12" />
				<rect class="cls-2" x="78.92" y="1" width="6.65" height="10" />
				<rect class="cls-2" x="83.07" y="2.25" width="4.98" height="7.5" />
				<rect class="cls-3" x="66.46" y="6" width="12.46" height="6" />
				<text class="cls-4" transform="translate(27.41 7.64) scale(0.83 1)">
					{props.name}
				</text>
			</g>
		</g>
